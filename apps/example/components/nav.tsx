					...
					{NAV_LINKS.map((link) =>
						link.external ? (
							<a
								...
								className="block py-2.5 px-3 rounded-full text-xs leading-none font-medium text-neutral-600 dark:text-neutral-300 hover:text-foreground transition-colors"
							>
								{link.label}
							</a>
						) : (
